...
img = cv2.imread("/Users/daisymaturo/Downloads/microvascularpython/RetinaNetwork3_InVivo_Mithun/superficial_layer.png")
...
cv2.imwrite("zzz.png", output_bil)

img = cv2.imread("/Users/daisymaturo/Downloads/microvascularpython/zzz.png")
rows, cols = img.shape[:2]
